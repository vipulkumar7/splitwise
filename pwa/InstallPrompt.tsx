    ...
    return (
        <AnimatePresence>
            {show && (
                ...
                >
                    <div className="w-full max-w-md bg-white/10 backdrop-blur-xl border border-white/20 shadow-xl rounded-2xl p-5 flex items-center gap-4 mb-16">
                        {/* ICON */}
                        ...
                        <button
                            onClick={handleClose}
                            className="absolute top-2 right-2 text-gray-300 hover:text-white -mt-2"
                        >
                            <FiX size={16} />
                        </button>
                    </div>
