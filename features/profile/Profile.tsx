...
export default function Profile({ user }: IProfile) {
  return (
    <div className="flex flex-1 items-center justify-center px-4 text-white">
      <div className="w-full max-w-md pb-24">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-xl mb-4">
          ...
          <button
            disabled
            className="mt-6 w-full p-3 rounded-lg border border-gray-300 text-black text-sm font-medium cursor-not-allowed bg-gray-100"
          >
            Edit Profile
          </button>
        </div>
